                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-dark" href="#" ><i class="fa fa-fw fa-user"></i>Teachers<span class="badge badge-success"></span></a>
                                
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-dark" href="#" ><i class="fa fa-fw fa-user-circle"></i>Student<span class="badge badge-success"></span></a>
                                
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-dark" href="#" ><i class="fa fa-fw fa-user-circle"></i>Accountants<span class="badge badge-success"></span></a>
                                
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-dark" href="#" ><i class="fa fa-fw fa-user-circle"></i>Librarians<span class="badge badge-success"></span></a>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header"> Total Incomes</h5>
                                    <div class="card-body">
